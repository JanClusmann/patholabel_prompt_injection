...
plot_2a <- ggplot(data_2a, aes(x = model_name, y = mean, fill = `Label_Type`)) +
  ...
  labs(y = "Accuracy") +
  scale_fill_manual(values = c("true" = "#999999", "false" = "#fbc9c4", "none" = "white")) +
  scale_color_manual(values = c("true" = "black", "false" = "black", none= "black")) +
  theme_minimal() +
  theme(
    axis.title.x = element_blank(),
...
# Save the plot
ggsave(filename = paste0(fig_path, "Accuracy_all_tasks.svg"), plot = plot_2a, width = 9, height = 6, bg = "transparent")
